...
void setup_scr_screen(lv_ui *ui)
{
	...
	lv_obj_set_style_bg_img_src(ui->screen, &_p0_240x240, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->screen_label_1, 103, 68);
	...
	lv_obj_set_pos(ui->screen_label_2, 85, 104);
	lv_obj_set_size(ui->screen_label_2, 100, 32);

	//Write style for screen_label_2, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
	lv_obj_set_style_border_width(ui->screen_label_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_radius(ui->screen_label_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_color(ui->screen_label_2, lv_color_hex(0x2FDA64), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(ui->screen_label_2, &lv_font_Antonio_Regular_16, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_label_set_text(ui->screen_label_3, "Sys_Power:");
	lv_label_set_long_mode(ui->screen_label_3, LV_LABEL_LONG_WRAP);
	lv_obj_set_pos(ui->screen_label_3, 12, 68);
	lv_obj_set_size(ui->screen_label_3, 133, 22);
	...
	lv_obj_set_pos(ui->screen_btn_1, 70, 149);
